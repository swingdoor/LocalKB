...
- 内置“经典”“纸张”“夜间”三套统一主题，可在「设置 - 基础设置 - 外观」中选择并保存
- 主题作用于整个应用工作区和原生窗口；缺失、旧版或未知主题值会安全回退到“经典”
- 文档内和编辑窗口中的画布、思维导图会采用与“经典”“纸张”“夜间”匹配的屏幕主题；切换只改变显示，不改写文档自定义颜色、Excalidraw 场景、思维导图数据或固定导出内容
- 支持自定义快捷键
- 支持恢复默认快捷键配置
