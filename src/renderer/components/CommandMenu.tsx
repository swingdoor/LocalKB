...
const baseCommands: CommandItem[] = [
  ...
  { id: 'details', title: commandTitle('details'), icon: <ListCollapse className="h-4 w-4" /> },
  {
    ...
    shortcut: { key: '8', modifiers: ['ctrl', 'shift'] },
  },
  {
    id: 'ordered',
    ...
    shortcut: { key: '7', modifiers: ['ctrl', 'shift'] },
  },
  {
    id: 'task',
  ...
  },
  {
    ...
    shortcut: { key: 'c', modifiers: ['ctrl', 'alt'] },
  },
  {
    id: 'table',
  ...
  },
  {
    ...
    shortcut: { key: 'm', modifiers: ['ctrl', 'shift'] },
  },
]
              ...
              .map((nav) => {
                ...
                return (
                  ...
                  >
                    ...
                    {cmd.shortcut && (
                      <kbd className="command-shortcut">{formatHotkeyDisplay(cmd.shortcut)}</kbd>
                    )}
                  </div>
                )
              })}
